...
public final class DefaultPofActions {
    ...
    public static PofAction addField(short fieldId, short fieldPosition, int fieldLength, String fieldValue) {
        checkNotNull( Short.valueOf(fieldId), "fieldId cannot be null");
        checkNotNull( Short.valueOf(fieldPosition), "fieldPosition cannot be null");
        checkNotNull( Integer.valueOf(fieldLength), "fieldLength cannot be null");
    ...
    public static PofAction calcCheckSum(byte checksumPosType, byte calcPosType,
        ...
        checkNotNull( Byte.valueOf(checksumPosType), "checksumPosType cannot be null");
        checkNotNull( Byte.valueOf(calcPosType), "calcPosType cannot be null");
        checkNotNull( Short.valueOf(checksumPosition), "checksumPosition cannot be null");
        checkNotNull( Short.valueOf(checksumLength), "checksumLength cannot be null");
        checkNotNull( Short.valueOf(calcStartPosition), "calcStartPosition cannot be null");
        checkNotNull( Short.valueOf(calcLength), "calcLength cannot be null");
    ...
    public static PofAction counter(int counterId) {
        checkNotNull( Integer.valueOf(counterId), "counterId cannot be null");
    ...
    public static PofAction deleteField(int tagPosition, int tagLengthValue) {
        ...
        checkNotNull( Integer.valueOf(tagLengthValue), "tagLengthField cannot be null");
    ...
    public static PofAction drop(int reason) {
        checkNotNull( Integer.valueOf(reason), "reason cannot be null");
    ...
    public static PofAction group(int groupId) {
        checkNotNull( Integer.valueOf(groupId), "groupId cannot be null");
    ...
    public static PofAction modifyField(OFMatch20 matchField, int increment) {
        ...
        checkNotNull( Integer.valueOf(increment), "increment cannot be null");
    ...
    public static PofAction output(short metadateOffset,
        ...
        checkNotNull( Integer.valueOf(protId), "protId cannot be null");
        checkNotNull( Short.valueOf(metadateOffset), "metadateOffset cannot be null");
        checkNotNull( Short.valueOf(metadataLength), "metadataLength cannot be null");
        checkNotNull( Short.valueOf(packetOffset), "packetOffset cannot be null");
        return new PofActionOutput((byte) 0, metadateOffset, metadataLength, packetOffset, protId);//portIdValueType 设置为0 是干什么？？？？？
    }
    ...
    public static PofAction setField(short fieldId, short fieldOffset, int fieldLen, String value, String mask) {
        ...
        checkNotNull( Short.valueOf(fieldId), "fieldSetting cannot be null");
        checkNotNull( Integer.valueOf(fieldLen), "fieldLen cannot be null");
        checkNotNull( Short.valueOf(fieldOffset), "fieldOffset cannot be null");
    ...
    public static PofAction setFieldFromMetadata(OFMatch20 fieldSetting, short metadataOffset) {
        checkNotNull(fieldSetting, "fieldSetting cannot be null");
        checkNotNull( Short.valueOf(metadataOffset), "metadataOffset cannot be null");
    ...
    public static final class PofActionAddField implements PofAction {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof OFActionAddField) {
                ...
                return  actionAddField.getFieldPosition() == that.getFieldPosition() &&
                        actionAddField.getFieldLength() == that.getLength() &&
                        Arrays.equals(actionAddField.getFieldValue(), that.getFieldValue());
    ...
    public static final class PofActionOutput implements PofAction {
        ...
        private PofActionOutput(byte portIdValueType, short metadateOffset,
            ...
            if (portIdValueType == 0) {
                checkNotNull( Integer.valueOf(portId));
            }
