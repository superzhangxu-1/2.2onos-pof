 ...
 */
package org.onosproject.pof.config;
...
/**
 * Configuration for Pof devices.
 */
@Beta
public class PofDeviceConfig extends Config<DeviceId> {

    /**
     * netcfg ConfigKey.
     */
    public static final String CONFIG_KEY = "pof";
     ...
     */
    public PofDeviceConfig setKeyAlias(String keyAlias) {
        return (PofDeviceConfig) setOrClear(CLIENT_KEY_ALIAS, keyAlias);
    }
}
