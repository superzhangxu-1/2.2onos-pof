...
PROTOCOL_MAP = {
    ...
    "//protocols/pof/api:onos-protocols-pof-api": ["seba", "sona"],
    "//protocols/pof/ctl:onos-protocols-pof-ctl": ["seba", "sona"],
...
PROVIDER_APP_MAP = {
	...
	"//providers/pof/app:onos-providers-pof-app-oar": ["seba", "sona"],
    "//providers/pof/base:onos-providers-pof-base-oar": ["seba", "sona"],
    "//providers/pof/message:onos-providers-pof-message-oar": ["seba", "sona"],
