...
public final class DefaultPofInstructions {
    ...
    public static PofInstruction calculateField(OFInstructionCalculateField.OFCalcType type,
        ...
        checkNotNull( Byte.valueOf(srcValueType), "srcValueType cannot be null");
        checkNotNull( destField, "destField cannot be null");
        checkNotNull( Integer.valueOf(srcValue), "srcValue cannot be null");
    ...
    public static PofInstruction gotoDirectTable(byte nextTableId, byte indexType,
        ...
        checkNotNull( Byte.valueOf(nextTableId), "nextTableId cannot be null");
        checkNotNull( Byte.valueOf(indexType), "indexType cannot be null");
        checkNotNull( Short.valueOf(packetOffset), "packetOffset cannot be null");
        checkNotNull( Integer.valueOf(indexValue), "indexValue cannot be null");
    ...
    public static PofInstruction gotoTable(byte nextTableId, byte matchFieldNum,
        ...
        checkNotNull( Byte.valueOf(nextTableId), "nextTableId cannot be null");
        checkNotNull( Byte.valueOf(matchFieldNum), "matchFieldNum cannot be null");
        checkNotNull( Short.valueOf(packetOffset), "packetOffset cannot be null");
    ...
    public static PofInstruction meter(int meterId) {
        checkNotNull( Integer.valueOf(meterId), "meterId cannot be null");
    ...
    public static PofInstruction writeMetadata(short metadataOffset, short writeLength, byte[] value) {
        ...
        checkNotNull( Short.valueOf(writeLength), "writeLength cannot be null");
    ...
    public static final class PofInstructionWriteMetadata implements PofInstruction {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof OFInstructionWriteMetadata) {
                ...
                return  insWriteMetadata.getMetadataOffset() == that.getMetadataOffset() &&
                        insWriteMetadata.getWriteLength() ==  that.getWriteLength() &&
                        Arrays.equals(insWriteMetadata.getValue(), that.getValue());
